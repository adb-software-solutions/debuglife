...
from .models import ProductCategory, ProductSubCategory, AffiliateProgram, AffiliateProduct
...
class AffiliateProductAdmin(admin.ModelAdmin[AffiliateProduct]):
    list_display = ("product_name", "product_description", "product_image", "product_price", "affiliate_link", "affiliate_program", "product_sub_category")
