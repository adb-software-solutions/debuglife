// src/constants/transitionWords.ts
export const singleWords = [
  ...
  export const multipleWords = [
    ...
    "analogous to", "although this may be true", "another key point", "as a matter of fact", "as a result",
  ...
  // Paired transition expressions.
  export const pairedTransitions = [
    ["both", "and"],
    ["not only", "but also"],
    ["neither", "nor"],
    ["either", "or"],
